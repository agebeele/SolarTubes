...
public class usuario_acercaNosotros extends AppCompatActivity {
    VideoView mVideoView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_usuario_acerca_nosotros);
    ...
    private void inicia() {
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(usuario_acercaNosotros.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 0001);
        }
    }
