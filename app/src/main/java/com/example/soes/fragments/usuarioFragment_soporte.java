...
public class usuarioFragment_soporte extends Fragment {
    RecyclerView recyclerView;
    usuario_soporte myAdapter;
    String msj;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_usuario_soporte, container, false);

        recyclerView = v.findViewById(R.id.recyclerView_inicio);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        myAdapter = new usuario_soporte(idList, companiaList, telefonoList, imageList);
        myAdapter.setOnItemClickListener(new usuario_soporte.OnItemClickListener() {
            @Override
            public void onItemClick(int position) {

                Intent i = new Intent(getActivity(), usuario_soporteItem.class);
